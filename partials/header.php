        ...
        <div data-collapse="medium" data-animation="default" data-duration="400" role="navigation"
            ...
            <ul class="l-flex l-flex--center l-flex__wrap">
                ...
                <li class="c-header__brand">
                    <a title="Início" href="index.php" class="w-inline-block w--current">
                        <img src="images/Logo_1.png" alt="Reverbera, áudio livros gratuitos">
                    </a>
                </li>
                ...
                <li>
                    <a href="ajuda-de-acessiblidade.php" accesskey="3" class="c__link c__trasition300">
